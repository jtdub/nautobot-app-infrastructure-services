...
class InfrastructureServiceModel(PrimaryModel):  # pylint: disable=too-many-ancestors
    """Base model for Infrastructure Services app."""
    ...
    class Meta:
        ...
        # verbose_name_plural = "Infrastructure Servicess"
